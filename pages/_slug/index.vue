    ...
    head () {
      return {
        ...
        meta: [
          ...
          { hid: "twitter:player", name: "twitter:player", content: "https://player.vimeo.com/video/" + this.vimeoId },
          { hid: "twitter:player:url", name: "twitter:player:url", content: "https://player.vimeo.com/video/" + this.vimeoId },
          { hid: "twitter:player:secure_url", name: "twitter:player:secure_url", content: "https://player.vimeo.com/video/" + this.vimeoId },
          { hid: "twitter:creator", name: "twitter:creator", content: "hoodrychx" }
        ],
        link: [
